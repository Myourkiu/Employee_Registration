...
function removeError(index, spanIndex) {
...
function setError(index, spanIndex) {
...
function comparePassword() {
  if (
    inputArea[1].value == inputArea[2].value &&
    inputArea[2].value.length >= 8
  ) {
    removeError(2,2);
  } else {
    setError(2,2);
...
let currentStep = 1;
const updateSteps = (e) => {
  if (e.target.classList == "btn_next1") {
    if (
      inputArea[0].classList.contains("inputValidated") &&
      inputArea[1].classList.contains("inputValidated") &&
      inputArea[2].classList.contains("inputValidated")
    ) {
      currentStep++;
    }
  }

  if (e.target.classList == "btn_next2") {
    if (
      inputArea[3].classList.contains("inputValidated") &&
      inputArea[4].classList.contains("inputValidated") &&
      inputArea[5].classList.contains("inputValidated")
    ) {
      currentStep++;
    }
  }

  if (e.target.classList == "btn_next3") {
    if (
      inputArea[6].classList.contains("inputValidated") &&
      inputArea[7].classList.contains("inputValidated")
    ) {
      currentStep++;
    }
  }
